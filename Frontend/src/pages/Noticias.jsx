...
export default function Noticias() {
    ...
    async function fetchNoticias() {
      try {
        ...
        const resposta = await fetch(
          "https://two026-2-veritasia.onrender.com/noticias/",
        );
        ...
        const noticiasFormatadas = dadosDoBack.map((n) => ({
          ...
          resumo:
            (n.resumo_blur || "Resumo não disponível")
              .substring(0, 120)
              .trim() + "...",
  ...
  const ESTADOS = useMemo(
    () =>
      [...new Set(noticiasAPI.map((n) => n.estado))]
        .filter((e) => e !== "N/A")
        .sort(),
    [noticiasAPI],
  );
  const VEICULOS = useMemo(
    () =>
      [...new Set(noticiasAPI.map((n) => n.fonte))]
      ...
      <main className="content">
        ...
        <div className="noticias-container">
          ...
          <div className="news-grid">
            {loading ? (
              <div className="noticias-empty-card">Carregando notícias...</div>
              ...
              noticiasPagina.map((n) => (
                ...
                >
                  <h3>
                    <img src={n.imagem} alt={n.titulo} className="news-image" />
                  </h3>
